          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            {showCheckboxes && (<>
              ...
              <Checkbox
                ...
                onChange={handleChange}
              >
                Нажимая кнопку “Оплатить” Вы оплачиваете 29₽ и подтверждаете ознакомление с автоматическими списаниями. Через 24 часа, будет совершено автоматическое продление за 2023 р. за 7 дней, либо 889 р на 3 дня, 589 руб. на 2 дня или 289 руб. за 1 день
              </Checkbox>
            </>)}
